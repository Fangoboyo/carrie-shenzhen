...
export default function Profile() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!uploadUrl) {
        throw new Error('Location header not found in the upload session response.');
      }
  ...
  return (
    <div className="scrapbook-container">
      ...
      <div className="notebook-paper">
        ...
        <div style={{ marginTop: '30px', padding: '20px', border: '2px dashed var(--accent)', textAlign: 'center' }}>
          <label className="btn-stamp" style={{ cursor: isUploading ? 'not-allowed' : 'pointer' }}>
